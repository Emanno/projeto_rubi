<?php
	...
	require "classes/banco.php";
		...
		FROM tbl_maquina 
						WHERE tbl_maquina.nome = 'Centermax'";
    ...
    tbl_acessorios_uso.status_reserva as 'StatusReserva', tbl_acessorios_uso.dt_reserva as 'DtReserva', tbl_acessorios_uso.dt_ult_pedido_recebido as 'DtUltimoPedido'
			...
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Master'";
				$resultado = mysqli_query($conexao, $sqlBusca);
		...
		function buscar_p1($conexao)
			{				
				$sqlBusca = "SELECT tbl_pontas.num_nome as 'NumeroPonta'
		FROM tbl_pontas 
						WHERE tbl_pontas.id_pontas = '27'";
				$resultado = mysqli_query($conexao, $sqlBusca);

				$b_p1 = [];

				while ($b_p1 = mysqli_fetch_assoc($resultado)){
					$p1[]=$b_p1;
				}
		...
		function buscar_informacao_p1($conexao)
			{				
				$sqlBusca = "SELECT tbl_maquina.nome as 'NomeMaquina', tbl_pontas.num_nome as 'NumeroPonta', 
	tbl_tipo_acessorios.descricao as 'AcessoriosPonta', tbl_acessorios_uso.haste as 'HastePonta', 
	tbl_acessorios_uso.comprimento as 'ComprimentoPonta', tbl_tipo_rosca.descricao as 'TipoRosca', tbl_material.descricao as 'Material',
		...
		FROM tbl_maquina JOIN tbl_pontas JOIN tbl_tipo_acessorios JOIN tbl_localizacao JOIN tbl_acessorios_uso JOIN tbl_material JOIN tbl_tipo_rosca
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_espec_sap.id = tbl_acessorios_uso.tbl_espec_sap_id
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Ponta 1'";
				$resultado = mysqli_query($conexao, $sqlBusca);

				$infos_p1 = [];

				while ($info_p1 = mysqli_fetch_assoc($resultado)){
					$infos_p1[]=$info_p1;
				}
...
function buscar_sensor($conexao)
			{				
				$sqlBusca = "SELECT tbl_pontas.num_nome as 'NumeroPonta'
		FROM tbl_pontas 
						WHERE tbl_pontas.id_pontas = '28'";
				$resultado = mysqli_query($conexao, $sqlBusca);

				$b_sensor = [];

				while ($b_sensor = mysqli_fetch_assoc($resultado)){
					$sensor[]=$b_sensor;
				}
		...
		function buscar_informacao_sensor($conexao)
			{				
				$sqlBusca = "SELECT tbl_maquina.nome as 'NomeMaquina', tbl_pontas.num_nome as 'NumeroPonta', 
	tbl_tipo_acessorios.descricao as 'AcessoriosPonta', tbl_acessorios_uso.haste as 'HastePonta', 
	tbl_acessorios_uso.comprimento as 'ComprimentoPonta', tbl_tipo_rosca.descricao as 'TipoRosca', tbl_material.descricao as 'Material',
		...
		FROM tbl_maquina JOIN tbl_pontas JOIN tbl_tipo_acessorios JOIN tbl_localizacao JOIN tbl_acessorios_uso JOIN tbl_material JOIN tbl_tipo_rosca
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_espec_sap.id = tbl_acessorios_uso.tbl_espec_sap_id
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Sensor Temp'";
				$resultado = mysqli_query($conexao, $sqlBusca);

				$infos_sensor = [];

				while ($info_sensor = mysqli_fetch_assoc($resultado)){
					$infos_sensor[]=$info_sensor;
				}
		...
		FROM tbl_maquina JOIN tbl_pontas JOIN tbl_tipo_acessorios JOIN tbl_localizacao JOIN tbl_acessorios_uso JOIN tbl_material JOIN tbl_tipo_rosca
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_espec_sap.id = tbl_acessorios_uso.tbl_espec_sap_id
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Ponta 2'";
				$resultado = mysqli_query($conexao, $sqlBusca);
		...
		FROM tbl_maquina JOIN tbl_pontas JOIN tbl_tipo_acessorios JOIN tbl_localizacao JOIN tbl_acessorios_uso JOIN tbl_material JOIN tbl_tipo_rosca
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_espec_sap.id = tbl_acessorios_uso.tbl_espec_sap_id
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Ponta 3'";
				$resultado = mysqli_query($conexao, $sqlBusca);
		...
		FROM tbl_maquina JOIN tbl_pontas JOIN tbl_tipo_acessorios JOIN tbl_localizacao JOIN tbl_acessorios_uso JOIN tbl_material JOIN tbl_tipo_rosca
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_espec_sap.id = tbl_acessorios_uso.tbl_espec_sap_id
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Ponta 4'";
				$resultado = mysqli_query($conexao, $sqlBusca);
		...
		FROM tbl_maquina JOIN tbl_pontas JOIN tbl_tipo_acessorios JOIN tbl_localizacao JOIN tbl_acessorios_uso JOIN tbl_material JOIN tbl_tipo_rosca
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_espec_sap.id = tbl_acessorios_uso.tbl_espec_sap_id
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Ponta 5'";
				$resultado = mysqli_query($conexao, $sqlBusca);
		...
		FROM tbl_maquina JOIN tbl_pontas JOIN tbl_tipo_acessorios JOIN tbl_localizacao JOIN tbl_acessorios_uso JOIN tbl_material JOIN tbl_tipo_rosca
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_espec_sap.id = tbl_acessorios_uso.tbl_espec_sap_id
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Ponta 6'";
				$resultado = mysqli_query($conexao, $sqlBusca);
		...
		FROM tbl_maquina JOIN tbl_pontas JOIN tbl_tipo_acessorios JOIN tbl_localizacao JOIN tbl_acessorios_uso JOIN tbl_material JOIN tbl_tipo_rosca
			JOIN tbl_discrim_peca JOIN tbl_qnt_uso_acess_uso JOIN tbl_qnt_estoque_acess_uso JOIN tbl_espec_fabrica JOIN tbl_espec_sap JOIN tbl_normal
				ON tbl_maquina.id_maquina = tbl_pontas.tbl_maquina_id_maquina 
                    ...
                    AND tbl_espec_sap.id = tbl_acessorios_uso.tbl_espec_sap_id
                    AND tbl_normal.id_normal = tbl_acessorios_uso.tbl_normal_id_normal
						WHERE tbl_maquina.nome = 'Centermax' AND tbl_pontas.num_nome='Itens'";
				$resultado = mysqli_query($conexao, $sqlBusca);
...
<html>
    <head>
        ...
        <?php
			...
			$lista_p1 = buscar_p1($conexao);
            $lista_info_p1 = buscar_informacao_p1($conexao);
			$lista_sensor = buscar_sensor($conexao);
            $lista_info_sensor = buscar_informacao_sensor($conexao);
		...
		<div class="container">
			...
			<table class="table table-sm table-striped">
						...
						<center>
							<a tabindex="0" data-html="true" data-toggle="popover" data-trigger="focus" data-placement="top" title="Legenda" 
								data-content="<table>
									...
									<tr>
										<td colspan='2'><Center> M_A = Maleta </centeR></td>
									</tr>
									<tr>
										<td colspan='2'><Center> CENT = Centermax </centeR></td>
									</tr>
									<tr>
				  ...
				  <thead>
					<tr>
						<td colspan='17'>
						<h5><center><?php foreach ($lista_sensor as $sensor) { ?>
							<?php echo utf8_encode ($sensor['NumeroPonta']); ?>
						<?php } ?>
						</center></h5>
						</td>
					</tr>
				  ...
				  <tbody>
				  <?php foreach ($lista_info_sensor as $info_sensor) { ?>
							<tr>
								
								<td><?php echo utf8_encode ($info_sensor['AcessoriosPonta']); ?></td>
								<td><center><?php echo utf8_encode ($info_sensor['HastePonta']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['ComprimentoPonta']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['TipoRosca']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['Material']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['DiscrimPeca']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['Localizacao']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['QntUso']); ?></center></td>
								<?php
									$lim_ok = $info_sensor['Ok'];
									$lim_nok = $info_sensor['Nok'];
									$qnt = $info_sensor['QntEst'];

									if (is_null($lim_ok) AND is_null($lim_nok))
									{
										echo "<td><center>".$info_sensor['QntEst']."</center></td>";
									}
									else if($qnt > $lim_ok)
									{
										echo "<td style='background-color:#00b050;'><center>".$info_sensor['QntEst']."</center></td>";
									}
									else if ($qnt < $lim_nok)
									{
										echo "<td style='background-color:#ff0000;'><center>".$info_sensor['QntEst']."</center></td>";
									}
									else
									{
										echo "<td style='background-color:#ffff00;'><center>".$info_sensor['QntEst']."</center></td>";
									}
								?>
								<td><center><?php echo utf8_encode ($info_sensor['EspecFab']); ?></center></td>		
								<td><center><?php echo utf8_encode ($info_sensor['EspecSap']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['Normal']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['NumReservaSap']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['QntSolic']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['StatusReserva']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['DtReserva']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_sensor['DtUltimoPedido']); ?></center></td>						
				  ...
				  <thead>
					<tr>
						<td colspan='17'>
						<h5><center><?php foreach ($lista_p1 as $p1) { ?>
							<?php echo utf8_encode ($p1['NumeroPonta']); ?>
						<?php } ?>
						</center></h5>
						</td>
					</tr>
				  ...
				  <tbody>
				  <?php foreach ($lista_info_p1 as $info_p1) { ?>
							<tr>
								
								<td><?php echo utf8_encode ($info_p1['AcessoriosPonta']); ?></td>
								<td><center><?php echo utf8_encode ($info_p1['HastePonta']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['ComprimentoPonta']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['TipoRosca']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['Material']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['DiscrimPeca']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['Localizacao']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['QntUso']); ?></center></td>
								<?php
									$lim_ok = $info_p1['Ok'];
									$lim_nok = $info_p1['Nok'];
									$qnt = $info_p1['QntEst'];
									...
									if (is_null($lim_ok) AND is_null($lim_nok))
									{
										echo "<td><center>".$info_p1['QntEst']."</center></td>";
									}
									else if($qnt > $lim_ok)
									{
										echo "<td style='background-color:#00b050;'><center>".$info_p1['QntEst']."</center></td>";
									}
									else if ($qnt < $lim_nok)
									{
										echo "<td style='background-color:#ff0000;'><center>".$info_p1['QntEst']."</center></td>";
									}
									else
									{
										echo "<td style='background-color:#ffff00;'><center>".$info_p1['QntEst']."</center></td>";
									}
								?>
								<td><center><?php echo utf8_encode ($info_p1['EspecFab']); ?></center></td>		
								<td><center><?php echo utf8_encode ($info_p1['EspecSap']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['Normal']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['NumReservaSap']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['QntSolic']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['StatusReserva']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['DtReserva']); ?></center></td>
								<td><center><?php echo utf8_encode ($info_p1['DtUltimoPedido']); ?></center></td>						
